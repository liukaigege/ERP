<template>
	<el-dialog title="移出搁置" v-model="ifShow" :width="640" custom-class="myDialog" :close-on-click-modal="false" :destroy-on-close="true" @close="closeEvent">
		<div class="contentView">
			<el-form  :model="form" :rules="rules" ref="formRef">
        <i class="el-icon-warning"></i>
        <span class="text">确认将勾选的商品移出搁置？</span>
				<el-form-item label="备注内容:" style="margin-top: 24px" prop="remark">
...
<script>
  ...
  import { ElMessage } from 'element-plus'
	import { outLay } from '@/api/goods/quotedPrice.js'
	export default {
		props: {
			goodsIds: {
				type: Array,
