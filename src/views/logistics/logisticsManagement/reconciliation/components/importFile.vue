<template>
<div>
  <el-dialog title="导入修改" v-model="show" width="480px" @close="close" :close-on-click-modal="false">
...
import { importFile } from '../api/api.js'
...
export default {
  ...
  setup(props, ctx) {
    const state = reactive({
      show: true,
      templatePath: 'http://vango-erp-test.oss-cn-hangzhou.aliyuncs.com/import/ERP_MODULE/20220412/102028_ERP_MODULE_5689.xlsx',
